 ...
 */
public class ToolPixelShaderBlend implements ToolPixelShader {
    int color = 0xFF000000;
    public ToolPixelShaderBlend(int col){
        color = col;
    }
    
    @Override
    public int getColor(int x, int y, PixelReader reader, PixelWriter writer) {
        int tcolor = ToolGraphics.safeRead(reader, x, y);
        //System.out.println(""+color);
        return JavaShop.overlayARGBonARGB(color, tcolor);
    }
