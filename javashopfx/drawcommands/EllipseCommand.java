 ...
 */
public class EllipseCommand extends DrawCommand{
    public int x0 = 0;
    public int y0 = 0;
    public int x1 = 0;
    public int y1 = 0;
    ...
    public void apply(PixelReader reader, PixelReader cache, PixelWriter writer, boolean copy) {      
        ...
        if(copy){
            ToolGraphics.fillEllipse(cache, writer, tx0, ty0, tx1, ty1,
                new ToolPixelShaderCopy(), new ToolPixelShaderCopy());
            
            return;
        }
        
        ToolGraphics.fillEllipse(cache, writer, tx0, ty0, tx1, ty1,
                new ToolPixelShaderBlend(outlineColor), new ToolPixelShaderBlend(fillColor));
    }
